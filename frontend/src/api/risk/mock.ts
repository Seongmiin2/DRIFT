...
const SEA_AREAS: Record<string, AreaDef> = {
  ...
  "통영/거제":         { bbox: [127.8, 34.5, 128.9, 34.95], maxWind: 12.2, maxWave: 1.6, baseDri: 0.58, peakOffsetH: 2 },
  "여수/거문도":       { bbox: [126.8, 33.5, 127.8, 34.5], maxWind: 11.8, maxWave: 1.5, baseDri: 0.51, peakOffsetH: 2 },
  "부산/영도":         { bbox: [128.9, 34.8, 129.6, 35.3], maxWind:  9.5, maxWave: 1.0, baseDri: 0.38, peakOffsetH: 4 },
