...
class EnginePredictionResult(BaseModel):
    ...
    particle_count: int = Field(default=1000, ge=100, description="Monte Carlo particles used")
    ...
    weight_l1: float = Field(default=0.30, ge=0.0, le=1.0)
    weight_l2: float = Field(default=0.50, ge=0.0, le=1.0)
    weight_l3: float = Field(default=0.20, ge=0.0, le=1.0)
